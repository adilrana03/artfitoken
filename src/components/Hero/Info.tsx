...
const InfoCard = ({ title, content, children }: any) => (
	<div className='bg-black rounded-3xl px-[46px] py-[42px] border-2 border-[#4467FF] shadow shadow-xl border-r-none '>
...
const TokenomicsInfo = () => {
	return (
		<div className='bg-[#0a0a1a] min-h-screen p-8'>
			<div className='md:max-w-7xl mx-auto grid gap-10 flex overflow-Scroll md:grid-cols-1 lg:grid-cols-2'>
					...
					content={
						<>
							<p className='mb-4'>
								...
								dedicating 30% of its revenue to buy back and
								burn tokens, thus increasing value for token
								holders.
							</p>
							<p className='mb-4'>
								Each part of the Artfi ecosystem has its own
								revenue stream, and our revenue share, buyback,
								and burn mechanism will be based on the total
								revenue generated by the entire Artfi Ecosystem.
							</p>
							<p>
								As the Artfi ecosystem expands, early adopters
								and investors stand to benefit from the growing
								value of it
							</p>
						</>
					}>
